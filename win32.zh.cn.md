...
- 高效且可靠的char(std::string)与wchar_t(std::wstring)相互转换
  ...
  std::wstring UTF8ToUTF16(const std::string_view utf8Str)
  {
      ...
      ::MultiByteToWideChar(CP_UTF8, MB_ERR_INVALID_CHARS, utf8Str.data(), utf8Length, utf16Str.data(), utf16Length);
      return utf16Str;
  }
  ...
  std::string UTF16ToUTF8(const std::wstring_view utf16Str)
  {
      ...
      ::WideCharToMultiByte(CP_UTF8, WC_ERR_INVALID_CHARS, utf16Str.data(), utf16Length, utf8Str.data(), utf8Length, nullptr, nullptr);
      return utf8Str;
  }
  ```
